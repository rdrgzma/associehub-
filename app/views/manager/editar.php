    ...
    <div class="px-6 py-6">
        ...
        <form action="<?= $postUrl ?>" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-6 gap-5">
            ...
            <div class="md:col-span-1">
                ...
                <input type="date" name="data_nascimento" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none transition" value="<?= htmlspecialchars($membro['data_nascimento'] ?? '') ?>">
            </div>

            <div class="md:col-span-1">
                <label class="block text-sm font-medium text-gray-700 mb-1">Idade</label>
                <input type="number" name="idade" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none transition" value="<?= htmlspecialchars($membro['idade'] ?? '') ?>">
            </div>
            ...
            <div class="md:col-span-4">
                ...
                <input type="text" name="conjuge_nome" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none transition" value="<?= htmlspecialchars($membro['conjuge_nome'] ?? '') ?>">
            </div>
            <div class="md:col-span-2">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="cep" id="cep" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none transition" value="<?= htmlspecialchars($membro['cep'] ?? '') ?>" placeholder="00000-000">
            </div>
            ...
            <div class="md:col-span-2 mt-6 pt-4 border-t border-gray-200 flex justify-end">
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2.5 px-6 rounded-lg transition shadow-md">
                    Salvar Alterações
                </button>
            </div>
        </form>
